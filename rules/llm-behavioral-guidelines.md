...
> [!NOTE]
> **TRIGGER:** LOAD ON BEHAVIORAL REVIEW, ONBOARDING, OR CODE REVIEW TASKS.
> **SCOPE:** EXPANDED SELF-TESTS AND DEEPER GUIDANCE FOR THE 4 CORE PRINCIPLES.
> **Prerequisite:** This file expands on the 4 principles in `rules/core-behavioral-compact.md`. Read that file first — it defines the base principles. This file provides only the expanded self-tests and deeper guidance.

## 1. Think Before Coding (Expanded)
*Base principle: See `rules/core-behavioral-compact.md` §1*
...
## 2. Simplicity First (Expanded)
*Base principle: See `rules/core-behavioral-compact.md` §2*
...
## 3. Surgical Changes (Expanded)
*Base principle: See `rules/core-behavioral-compact.md` §3*
...
## 4. Goal-Driven Execution (Expanded)
*Base principle: See `rules/core-behavioral-compact.md` §4*

### Self-Test
> Strong success criteria = independent execution. Weak criteria = constant back-and-forth.
...
**See also:** `EXAMPLES.md` for real-world ❌ vs ✅ code patterns demonstrating all 4 principles.
