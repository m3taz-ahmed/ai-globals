...
> [!NOTE]
> **TRIGGER:** LOAD ON EVERY CODE GENERATION / MODIFICATION TASK.
> **SCOPE:** APPLIES TO ALL PROJECTS IN THE ECOSYSTEM.
...
## 🛡️ SELF-AUDIT CHECKLIST (Mandatory)
Before submitting, run this check:
- [ ] Did I use any raw SQL concatenation? (If yes, fix it)
- [ ] Did I create a "God Class" or "God Method"? (If yes, split it)
- [ ] Are there any N+1 query patterns in my loops? (If yes, use eager loading)
- [ ] Did I leave any `TODO` or `FIXME` without a ticket? (If yes, add ticket or remove)
- [ ] Is my code surgical? (Did I change only what was asked?)
