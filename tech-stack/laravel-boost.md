...
## 3. BOUNDARIES
- **Not a Replacement:** Laravel Boosts supplements Laravel's core â€” it does not replace it. Core Laravel conventions (FormRequests, Policies, Resources) still apply.
