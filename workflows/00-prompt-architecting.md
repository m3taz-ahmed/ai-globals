...
4. [REQ] Routing: Use `skills/prompt-master-templates.md`. Apply tool-specific rules (e.g. XML for Claude).
5. [REQ] Synthesis: Final prompt MUST be English. Strip API keys. Do not use Tree/Graph of Thought unless requested.
6. [REQ] Audit: Check against `skills/prompt-master-patterns.md`. Ensure no vague verbs or dual-tasks.
