...
class StorageBackend(Protocol[K, V]):
    ...
    def put(self, key: K, value: V) -> None: ...  # pragma: no cover - Protocol stub
    def get(self, key: K) -> V | None: ...  # pragma: no cover - Protocol stub
    def delete(self, key: K) -> bool: ...  # pragma: no cover - Protocol stub
    def scan(self, key_filter: Any | None = None) -> list[V]: ...  # pragma: no cover - Protocol stub
    def keys(self) -> list[K]: ...  # pragma: no cover - Protocol stub
    def flush(self) -> None: ...  # pragma: no cover - Protocol stub
    def load(self) -> None: ...  # pragma: no cover - Protocol stub
    def clear(self) -> None: ...  # pragma: no cover - Protocol stub
    def count(self) -> int: ...  # pragma: no cover - Protocol stub
