...
11. [REQ] Query Context7 for any mobile/backend/library API before implementation; test on physical devices before release. Flutter testing two-tier `[TEST-07]`: FAST `flutter test <file>`; FULL `flutter test --coverage` + `integration_test/`.
